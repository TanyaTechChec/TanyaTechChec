...
<body><h2>👩‍💻 О себе:<h2><body>
  
Я QA-специалист с коммерческим опытом более года. Окончила курс Яндекс Практикума и уже успела поработать с реальными продуктами, багами и дедлайнами (да-да, они существуют 😄).

Бэкграунд менеджера помогает мне не только находить ошибки, но и понимать процессы, приоритеты и людей: планировать работу, доводить задачи до результата и нормально общаться с командой — даже когда что-то «упало, но не у меня».

Тестирование для меня — это не «сломать», а сделать продукт удобнее, стабильнее и дружелюбнее к пользователю.

### 🚀 Мои цели:
-Прокачиваться в QA и не путать «фичу» с «багом» без веских аргументов

-Участвовать в создании классных продуктов
...
- 📄 **Базы данных:** MySQL [SQL.py](https://github.com/TanyaTechChec/Yandex_Diplom/blob/6e7b01d69bf01255e4c550bc976c17a67d4d12b7/SQL.py) 👈🏻примеры запросов
- DBeaver [PostgreSQL](https://github.com/TanyaTechChec/PostgreSQL/blob/main/sql) 👈🏻 примеры запросов
...
- [Список покупок приложение IOS](https://github.com/TanyaTechChec/Shopping-List/blob/c0e47f5617968e386c32a2210aa9a10a6416c0e3/README.md)
  [![Благодарственное письмо](https://img.shields.io/badge/Благодарственное%20письмо-green?style=for-the-badge)](https://drive.google.com/file/d/1n61rGHtIr812JSXUaCwtz5tn0VZtHaDz/view?usp=sharing)
